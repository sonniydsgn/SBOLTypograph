...
* Сохранит стили текста после работы. Спасибо за код [Alexey Kalinin](https://github.com/sonniydsgn)
...
* Приведение российских телефонных номеров к формату ```Федеральный номер: 8 800 555-55-50``` ```Городской номер: +7 495 500-55-50, +7 4212 79-40-35```
